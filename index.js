...
const displayEntries = () => {
	...
	const table = `<table border="5px"><tr> <th>name</th> <th>Email</th> <th>Password</th> <th>dob</th> <th>accepted terms?</th> </tr> ${tableEntries} </table>`;
...
const saveUserForm = (event) => {
	...
	if (age >= 18 && age <= 55) {
		...
		alert("Sorr! You ahe should be between 18 and 55 years old to register.");
	}
};
